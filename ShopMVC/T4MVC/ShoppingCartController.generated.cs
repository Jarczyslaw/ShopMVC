...
namespace ShopMVC.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ShoppingCartController : ShopMVC.Controllers.ShoppingCartController
    {
        ...
        [NonAction]
        partial void GetCartCountOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetCartCount()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetCartCount);
            GetCartCountOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void GetCartValueOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetCartValue()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetCartValue);
            GetCartValueOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void GetCartLinkOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetCartLink()
        {
